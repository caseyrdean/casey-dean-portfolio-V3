      ...
      <div className="container">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center gap-8">
            <Link href="/#projects">
              <a className="font-subhead text-sm tracking-wider text-muted-foreground hover:text-primary transition-colors duration-300 uppercase">
                Projects
              </a>
            </Link>
            <Link href="/#awards">
              <a className="font-subhead text-sm tracking-wider text-muted-foreground hover:text-secondary transition-colors duration-300 uppercase">
                Awards
              </a>
            </Link>
            <Link href="/#contact">
              <a className="font-subhead text-sm tracking-wider text-muted-foreground hover:text-accent transition-colors duration-300 uppercase">
                Contact
              </a>
            </Link>
          </div>
