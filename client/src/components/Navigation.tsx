      ...
      <div className="container">
        <div className="flex items-center justify-between h-20">
          <Link href="/" className="flex items-center gap-3 group">
            <div className="w-[18px] h-[18px] border-2 border-primary bg-card flex items-center justify-center neon-border transition-all duration-300 group-hover:scale-110 overflow-hidden rounded">
